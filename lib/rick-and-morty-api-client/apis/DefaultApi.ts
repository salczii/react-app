...
import type { Character, FetchAllCharacters200Response } from '../models/index';
import {
  CharacterFromJSON,
  CharacterToJSON,
...
export class DefaultApi extends runtime.BaseAPI {
  ...
  async fetchAllCharactersRaw(
  ...
  ): Promise<runtime.ApiResponse<FetchAllCharacters200Response>> {
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      FetchAllCharacters200ResponseFromJSON(jsonValue),
    );
  }
  ...
  async fetchAllCharacters(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<FetchAllCharacters200Response> {
