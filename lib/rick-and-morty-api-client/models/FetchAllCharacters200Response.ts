...
import { CharacterFromJSON, CharacterFromJSONTyped, CharacterToJSON } from './Character';
...
export function FetchAllCharacters200ResponseFromJSONTyped(
  json: any,
  ...
  return {
    info:
      json['info'] == null ? undefined : FetchAllCharacters200ResponseInfoFromJSON(json['info']),
    results:
      json['results'] == null ? undefined : (json['results'] as Array<any>).map(CharacterFromJSON),
  };
}

export function FetchAllCharacters200ResponseToJSON(
  value?: FetchAllCharacters200Response | null,
): any {
  if (value == null) {
    return value;
  }
  return {
    ...
    results:
      value['results'] == null ? undefined : (value['results'] as Array<any>).map(CharacterToJSON),
  };
}
